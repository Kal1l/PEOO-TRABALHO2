...
public class Disciplina {
    ...
    public void deletarDisciplina() throws FileNotFoundException{
        String nomeDis = "";
        Scanner in = new Scanner(System.in);
        System.out.println("INSIRA O NOME DA DISCIPLINA :");
        nomeDis = in.nextLine();
        File file = new File("Diretório/disciplinas/"+nomeDis+ ".txt");
        File file2 = new File("Diretório/gabaritos/"+ nomeDis+".txt");
        File file3 = new File("Diretório/resultados/ordem_decrescente/"+nomeDis+".txt");
        File file4 = new File("Diretório/resultados/ordem_alfabetica/"+nomeDis+".txt");
        file.delete();
        file2.delete();
        file3.delete();
        file4.delete();
